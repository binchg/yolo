...
def train():
    ...
    for epoch in range(start_epoch, epochs):  # epoch ------------------------------------------------------------------
        ...
        # print(" " + str(nb) + "# total batch")
        for i, (imgs, targets, paths, _) in pbar:  # batch -------------------------------------------------------------
            ni = i + nb * epoch  # number integrated batches (since train start)
            # print(" " + str(ni) + "# start batch")
            imgs = imgs.to(device)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--token', type=str, default="958a8210e6eb9c1cd9326708bead6ffb6ed15b52", help='debug variable')
    parser.add_argument('--gpu', type=int, default=0, help='debug variable')
    parser.add_argument('--ipc', type=str, default='host', help='debug variable')
